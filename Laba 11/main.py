...
def insert_binary_sort(array):
    ...
    for barier in range(len(array)-1):
        ...
        new_index = binary_search(array[:barier+1],new_element)
...
def print_table(times_r,cnt_r,times_p,cnt_p,times_n,cnt_n,N):
    ...
    print('+----------------------|-------------+----------------|-------------+----------------|-------------+----------------+')
    print('|                      |    Время    |  Перестановки  |    Время    |  Перестановки  |    Время    |  Перестановки  |')
    print('+----------------------|-------------+----------------|-------------+----------------|-------------+----------------+')
...
def main():
    ...
    for qty in N:
        ...
        positive_array = [i for i in range(qty)]
        negative_array = [i for i in range(qty,0,-1)]
