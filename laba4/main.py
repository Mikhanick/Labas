...
start_value = float(input())  # Ввод начального элемента поледовательности
step = float(input())  # ввод шага последовательности
stop_value = float(input())  # ввод конца последовательности
